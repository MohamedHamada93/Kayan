...
class SuplieresCell: UITableViewCell {
    ...
    func setupview(){
        ...
        NSLayoutConstraint.activate([
            MainImage.topAnchor.constraint(equalTo: tablecell.topAnchor, constant: 10),
            MainImage.leadingAnchor.constraint(equalTo: tablecell.leadingAnchor, constant: 10),
        ...
        tablecell.addSubview(countLabel)
        NSLayoutConstraint.activate([
            countLabel.topAnchor.constraint(equalTo: DescLabel.bottomAnchor, constant: 0),
            countLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor, constant: 0)
            ])
